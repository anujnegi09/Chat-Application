...
const handleSendImage = async (e) => {
  ...
  return selectedUser ?  (
    <div className='h-full overflow-auto relative backdrop-blur-lg scrollbar-hide'>
      {/* ----------------header---------------- */}
      ...
      {/* ------------chat-area------------- */}
      <div className='flex flex-col h-[calc(100%-120px)] overflow-y-scroll [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden p-3 pb-6'>
